...
if (isset($_COOKIE['cook_name']) != "B_Lock" or isset($_GET["show_table"])) {
...
if (isset($result[0])) { ////Если текущая дата уже была записана то пропускаем блок для заполнения табеля
